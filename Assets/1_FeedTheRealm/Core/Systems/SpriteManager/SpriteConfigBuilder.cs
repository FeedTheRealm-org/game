...
public class SpriteConfigBuilder {
    ...
    public SpriteConfigBuilder AddTile(CharacterPartCategory part, FacingDirection direction, int tileX, int tileY) {
    ...
    public SpriteConfigBuilder AddTileToAllDirections(CharacterPartCategory part, int frontX, int frontY, int backX, int backY, int leftX, int leftY) {
