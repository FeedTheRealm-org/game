...
public class PlayerNameBillboard : MonoBehaviour {
    ...
    [SerializeField] private float screenOffsetX = 5f;
    [SerializeField] private float screenOffsetY = 40f;
    ...
    private void LateUpdate() {
        ...
        if (parentCanvas != null && parentCanvas.renderMode != RenderMode.WorldSpace && rectTransform != null) {
